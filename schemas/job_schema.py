...
class JobSchema(BaseModel):
    ...
    company: Optional[str] = Field(default=None, description="Company offering the job/internship")
    ...
    job_posted_date: Optional[str] = Field(default=None, description="Date when the job/internship was posted")
    ...
    job_type: Optional[Literal["Full-time", "Part-time", "Contract", "Temporary", "Internship"]] = Field(default=None, description="Type of the job/internship")
